...
(`baselines.BR0`). BR1 (CLI Skeleton) is authorized per
`.buildrail/specs/BR1-CLI-SKELETON.md`, but implementation has not yet
started. BR2–BR8 remain planned and not implementation-authorized.
