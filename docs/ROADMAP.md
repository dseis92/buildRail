...
As of this writing, BR0, BR1, and BR2 are complete, independently
reviewed, approved, and frozen at the baseline SHAs recorded in
`.buildrail/state.yml` (`baselines.BR0`, `baselines.BR1`, `baselines.BR2`).
