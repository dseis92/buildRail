# CLAUDE.md (BuildRail template — draft)

**Status: design draft (BR0). Not yet installed or enforced by any
BuildRail tooling.**

This is a template for the `CLAUDE.md` that a BuildRail-governed project
using Claude Code would use. It is intentionally thin: BuildRail's
canonical state and policy live in `.buildrail/`, not here.
